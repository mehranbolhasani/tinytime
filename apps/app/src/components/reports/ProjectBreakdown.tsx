...
function buildProjectBuckets(entries: TimeEntry[]): ProjectBucket[] {
  const buckets = entries.reduce<Record<string, ProjectBucket>>((map, entry) => {
...
export default function ProjectBreakdown({ entries }: ProjectBreakdownProps) {
